...
export function About() {
  return (
    <section
      className="relative w-full h-[50rem] md:h-[60rem] lg:h-[50rem] bg-cover bg-no-repeat flex justify-center"
      id="about"
    >
      <div className="relative md:w-2/3 flex flex-col gap-5 md:gap-10 md:flex-row items-center justify-center md:justify-between text-center md:text-left inset-0 z-20">
        <div className="w-full flex flex-col items-center md:items-start">
          <p className="text-3xl xl:text-4xl font-medium tracking-wider text-red-200">
            Olá, eu sou
          </p>
          <h1 className="text-7xl font-bold">Diogo</h1>

          <p className="md:w-2/3 text-base lg:text-xl font-medium mt-3">
            Sou um desenvolvedor frontend em busca de aprendizado e
            aprimoramento, estou constantemente procurando transformar ideias em
            codigos.
          </p>

          <a
            className="w-[45%] lg:w-[15%] text-center py-2 lg:py-3 mt-5 text-lg md:text-2xl font-bold border-2 border-red-200 text-red-200 transition duration-300 hover:scale-110 rounded-xl"
            href="#projects"
          >
            Meus Projetos
          </a>
