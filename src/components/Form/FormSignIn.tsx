...
export function FormSignIn() {
  ...
  return (
    <section className="h-screen flex items-center justify-center">
      <form className=" w-[25%]  bg-gray-800 p-10 rounded-2xl shadow-2xl" onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-5 items-center">
          ...
          <input
            className="w-full p-2 text-black rounded focus:outline-none placeholder:text-gray-300"
            type="text"
