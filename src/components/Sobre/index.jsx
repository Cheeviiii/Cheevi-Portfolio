...
export function Sobre() {
  return (
    <section className="h-screen flex items-center justify-center" id="sobre">
      <div className="w-full h-[500px] flex items-center">
        <div className="w-full p-10 flex flex-col lg:flex-row items-center justify-center gap-4 bg-[#141414] border-4 border-[#303030] ">
          <div className="px-10">
            <img
              className="rounded-xl md:rounded-3xl w-[150px] h-[150px] md:w-[300px] md:h-[300px] border-2 border-yellow-500"
              src={fotinha}
              alt="fotinha"
            />
          </div>
