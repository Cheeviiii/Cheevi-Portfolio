...
export function ModalViewProject({
  isOpen,
  closeModal,
  children,
}: CreateProjectProps) {
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-400 w-[50%] border border-gray-300 p-5 m-auto p-auto rounded-2xl shadow-2xl">
        <button
        ...
        <ScrollArea className="w-[80%] h-[90%] mx-[100px]">
          {children}
        </ScrollArea>
      </div>
    </div>
